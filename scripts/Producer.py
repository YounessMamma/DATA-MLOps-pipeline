...
# Define categories
categories = [
    "Income / salary", "Income / pension", "Income / reimbursement",
    "Income / benefits", "Income / financial", "Income / other"
]
...
while time.time() - start_time <= 60:
    ...
    transaction_with_category = f"{transaction}\t{category}"
    
    # Send message to Kafka
    producer.produce(topic_name, value=transaction_with_category)
